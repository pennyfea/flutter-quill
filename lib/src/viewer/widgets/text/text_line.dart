...
class _TextLineState extends State<TextLine> {
  final UniqueKey _richTextKey = UniqueKey();
...
class EditableTextLine extends RenderObjectWidget {
  ...
  RenderObject createRenderObject(BuildContext context) {
    return RenderEditableTextLine(line, textDirection, devicePixelRatio,
        _getPadding(), color, inlineCodeStyle, decoration);
  }
...
class RenderEditableTextLine extends RenderEditableBox {
  ...
  double get cursorHeight => preferredLineHeight(const TextPosition(offset: 0));
