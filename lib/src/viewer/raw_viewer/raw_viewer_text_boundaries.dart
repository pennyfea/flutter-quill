...
///
/// Depending on the implementation of the [QuillViewerTextBoundary], the input
...
///
/// To convert a "code-unit-based" [QuillViewerTextBoundary] to "caret-location-based",
/// use the [QuillEditorCollapsedSelectionBoundary] combinator.
abstract class QuillViewerTextBoundary {
  const QuillViewerTextBoundary();
...
class QuillViewerWhitespaceBoundary extends QuillViewerTextBoundary {
  const QuillViewerWhitespaceBoundary(this.textEditingValue);
...
class QuillEditorCharacterBoundary extends QuillViewerTextBoundary {
...
class QuillEditorWordBoundary extends QuillViewerTextBoundary {
...
// text-affinity-aware.
class QuillEditorLineBreak extends QuillViewerTextBoundary {
...
// position.
class QuillEditorDocumentBoundary extends QuillViewerTextBoundary {
...
class QuillEditorExpandedTextBoundary extends QuillViewerTextBoundary {
  QuillEditorExpandedTextBoundary(
      this.innerTextBoundary, this.outerTextBoundary);

  final QuillViewerTextBoundary innerTextBoundary;
  final QuillViewerTextBoundary outerTextBoundary;
...
class QuillEditorCollapsedSelectionBoundary extends QuillViewerTextBoundary {
...
// text boundary.
class QuillEditorMixedBoundary extends QuillViewerTextBoundary {
  QuillEditorMixedBoundary(this.leadingTextBoundary, this.trailingTextBoundary);

  final QuillViewerTextBoundary leadingTextBoundary;
  final QuillViewerTextBoundary trailingTextBoundary;
